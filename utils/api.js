...
var shoppTypeUrl=baseUrl + 'classify/getShopType';//查询左侧商品类别
var shoppTypeDetail=baseUrl +'classify/shoppList';//分类列表详情
var shoppDetailUrl=baseUrl + 'classify/getShopDetail';//
var searchHot = baseUrl + "classify/searchHot";//热门搜索
var shoppListUrl = baseUrl + "classify/shoppListUrl";//获取商品列表\顶部搜索框

//城市
var getCityList = baseUrl + 'City/getCityList'
var searchCityList=baseUrl + 'City/searchCityList'//搜索框查询车辆
// 车辆
